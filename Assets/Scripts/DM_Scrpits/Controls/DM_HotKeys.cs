...
//     version 1.7.0
//     from Assets/Scripts/DM_Scrpits/DM_HotKeys.inputactions
//
...
public partial class @DM_HotKeys: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_CameraSwitch_CamSwitchHotkey = m_CameraSwitch.FindAction("CamSwitch Hotkey", throwIfNotFound: true);
        // Camera KeyBoard
    ...
    private readonly InputAction m_CameraSwitch_CamSwitchHotkey;
    public struct CameraSwitchActions
    {
        private @DM_HotKeys m_Wrapper;
        public CameraSwitchActions(@DM_HotKeys wrapper) { m_Wrapper = wrapper; }
        public InputAction @CamSwitchHotkey => m_Wrapper.m_CameraSwitch_CamSwitchHotkey;
        ...
        public void AddCallbacks(ICameraSwitchActions instance)
        {
            ...
            @CamSwitchHotkey.started += instance.OnCamSwitchHotkey;
            @CamSwitchHotkey.performed += instance.OnCamSwitchHotkey;
            @CamSwitchHotkey.canceled += instance.OnCamSwitchHotkey;
        }
    ...
    {
        private @DM_HotKeys m_Wrapper;
        public CameraKeyBoardActions(@DM_HotKeys wrapper) { m_Wrapper = wrapper; }
    ...
    {
        void OnCamSwitchHotkey(InputAction.CallbackContext context);
    }
